...
public class ImageUtil {
    ...
    public byte[] scaleImage(String fileType, byte[] data, int maxWidth, int maxHeight) throws IOException {
        return toByteArray(scaleImage(toBufferedImage(data), maxWidth, maxHeight), formatName(fileType));
    }

    public byte[] scaleImageAndCropToSquare(String fileType, byte[] data, int maxSize) throws IOException {
        return toByteArray(scaleImageAndCropToSquare(toBufferedImage(data), maxSize), formatName(fileType));
    }

    public byte[] generateMessageImage(String message) throws IOException {
